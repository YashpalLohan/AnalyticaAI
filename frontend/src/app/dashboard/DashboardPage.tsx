...
const quickActions = [
  ...
  { tag: '03', icon: BarChart2,     label: 'View Analytics',  desc: 'Auto-generated charts',     to: '/analytics' },
  { tag: '04', icon: FileText,      label: 'Export Report',   desc: 'PDF or DOCX',               to: '/reports' },
]
